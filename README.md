...
>  This repository is for a relational database that stores the nformation of animals in a clinic.
...
- **[Clinic database]**
- **[Table containing animals data]**
- **[Write queries for quests]**
...
```sh
  cd my-folder
  git clone git@github.com:Cisco-the-wayword/Vet-Clinic
```
